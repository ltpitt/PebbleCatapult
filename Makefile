...
.DEFAULT_GOAL := help
.PHONY: help build build-release watchapp watchapp-install watch-test test check install clean \
...
watchapp-install: ## Build and install the Pebble watchapp on a connected watch
	@scripts/install-watchapp.sh
