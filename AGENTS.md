...
Apply repository-wide rules to every implementation plan and screen variant.
When Android-specific work is involved, also follow
...
watchapp. For Android-side logs and cross-process failures, follow
[`mobile/AGENTS.md`](mobile/AGENTS.md). Watch-side failures usually surface as
an error packet the watchapp sends *back* to the phone.
